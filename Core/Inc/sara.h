...
# define PID_SURGE_VEL_OUT_MIN -100f
# define PID_SURGE_VEL_OUT_MAX 100f
# define PID_SURGE_VEL_INT_MIN -10f
# define PID_SURGE_VEL_INT_MAX 10f

# define PID_SWAY_VEL_KP 1.5f
# define PID_SWAY_VEL_KI 0.1f
# define PID_SWAY_VEL_KD 0.05f
# define PID_SWAY_VEL_OUT_MIN -100f
# define PID_SWAY_VEL_OUT_MAX 100f
# define PID_SWAY_VEL_INT_MIN -10f
# define PID_SWAY_VEL_INT_MAX 10f

# define PID_HEAVE_VEL_KP 1.5f
# define PID_HEAVE_VEL_KI 0.1f
# define PID_HEAVE_VEL_KD 0.05f
# define PID_HEAVE_VEL_OUT_MIN -30f
# define PID_HEAVE_VEL_OUT_MAX 30f
# define PID_HEAVE_VEL_INT_MIN 0f
# define PID_HEAVE_VEL_INT_MAX 0f

# define PID_ROLL_KP 2.0f
# define PID_ROLL_KI 0.0f
# define PID_ROLL_KD 0.1f
# define PID_ROLL_OUT_MIN -30f
# define PID_ROLL_OUT_MAX 30f
...
# define PID_YAW_OUT_MIN -30f
# define PID_YAW_OUT_MAX 30f
